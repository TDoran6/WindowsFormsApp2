...
{
    public partial class AC_Timed_Form : Form
    {
                //30 seconds starting countdown
        int duration = 30;   			
        Boolean Active = false;
        private void AnnualTimedForm_Load(object sender, EventArgs e)
        {
            LoadData();
            Barcode();
            MySmartCardManager();
        ...
        public AC_Timed_Form()
        {
            InitializeComponent();
            Initialize_AC_Timed_Form(); // Needs to be added to load settings that have been put in 
            LoadData();
            Barcode();
            MySmartCardManager();
                    //List available Printers
        ...
        private void Initialize_AC_Timed_Form()
        {
            this.Height = Properties.Settings.Default.AC_Timed_Form_Height;
            this.Width = Properties.Settings.Default.AC_Timed_Form_Width;
                    // register event handler (AC_Timed_Form_ClosingEventHandler)
            this.FormClosing += AC_Timed_Form_ClosingEventHandler;
            this.StartPosition = FormStartPosition.Manual;
        } // End Initialize_AC_Timed_Form
                // method to handle the event (upon closing app)
        public void AC_Timed_Form_ClosingEventHandler(object sender, FormClosingEventArgs e)
        {
                    //set the values that were made in the Settings.settings
            Properties.Settings.Default.AC_Timed_Form_Height = this.Height;
            Properties.Settings.Default.AC_Timed_Form_Width = this.Width;
            Properties.Settings.Default.Save();
        } // End AC_Timed_Form_ClosingEventHandler
        ...
        {
            Barcode();
        } //End bindingNavigatorPositionItem_Click
        private void bindingNavigatorCountItem_Click(object sender, EventArgs e)
        {
            Barcode();
        } //End bindingNavigatorCountItem_Click
        ...
        private void batch1ToolStripButton_Click(object sender, EventArgs e)
        {
            Barcode();
            try
            {
        ...
        } //End batch1ToolStripButton_Click
        private void batch2ToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        } //End batch2ToolStripButton_Click
                            //
                            //
        ...
        public void SqlConnect()
        {
            ...
            {
                MessageBox.Show("Connection was not made with IRIS.");
            }
        } // end SqlConnect
