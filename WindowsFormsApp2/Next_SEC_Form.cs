...
{
    public partial class Next_SEC_Form : Form
    {
        int duration = 30;                                         // 30 seconds starting countdown			
        Boolean Active = false;
        public Next_SEC_Form()
        {
            InitializeComponent();
            Initialize_Next_SEC_Form(); // Needs to be added to load settings that have been put in 
        ...
        private void Initialize_Next_SEC_Form()
        {
            this.Height = Properties.Settings.Default.Next_SEC_Form_Height;
            this.Width = Properties.Settings.Default.Next_SEC_Form_Width;

            // register event handler (Next_SEC_Form_ClosingEventHandler)
            this.FormClosing += Next_SEC_Form_ClosingEventHandler;
            this.StartPosition = FormStartPosition.Manual;
        } // End Initialize_Next_SEC_Form
          // method to handle the event (upon closing app)
        public void Next_SEC_Form_ClosingEventHandler(object sender, FormClosingEventArgs e)
        {
            //set the settings that were made in the Settings.settings (in projects properties)
            Properties.Settings.Default.Next_SEC_Form_Height = this.Height;
            Properties.Settings.Default.Next_SEC_Form_Width = this.Width;
            Properties.Settings.Default.Save();
        } // End Next_SEC_Form_ClosingEventHandler
        ...
        private void secPrintPreviewButton_Click_1(object sender, EventArgs e)
        {
        ...
        } // End secPrintPreviewButton_Click_1
        ...
        private void secSinglePrint_Click_1(object sender, EventArgs e)
        {
            if (printerComboBox.SelectedItem == null)
            {
                MessageBox.Show("Please select a printer.");
