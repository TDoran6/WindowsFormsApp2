...
{
    public partial class Next_AC_Photo_Form : Form
    {
        public Next_AC_Photo_Form()
        {
            InitializeComponent();
            Initialize_Next_AC_Photo_Form(); // Needs to be added to load settings that have been put in 
        ...
        } // End Next_AC_Photo_Form
          //Method to load settings
        private void Initialize_Next_AC_Photo_Form()
        {
            this.Height = Properties.Settings.Default.Next_AC_Photo_Form_Height;
            this.Width = Properties.Settings.Default.Next_AC_Photo_Form_Width;

            // register event handler (Next_AC_Photo_Form ClosingEventHandler)
            this.FormClosing += Next_AC_Photo_Form_ClosingEventHandler;
            this.StartPosition = FormStartPosition.Manual;
        } // End Initialize_ Next_AC_Photo_Form

        // method to handle the event (upon closing app)
        public void Next_AC_Photo_Form_ClosingEventHandler(object sender, FormClosingEventArgs e)
        {
            //set the settings that were made in the Settings.settings (in projects properties)
            Properties.Settings.Default.Next_AC_Photo_Form_Height = this.Height;
            Properties.Settings.Default.Next_AC_Photo_Form_Width = this.Width;
            Properties.Settings.Default.Save();
        } // End Next_AC_Photo_Form_ClosingEventHandler
        ...
        private void makeSelectionButton_Click_1(object sender, EventArgs e)
        {
            Makeselection = true;
            cropPictureButton.Enabled = true;
        } // End makeSelectionButton_Click_1
        ...
        } // End resetButton_Click_1
        private void cropPictureButton_Click_1(object sender, EventArgs e)
        {
            SqlConnect();
            CreateDataAdapter2();
            FillTableAdapter2();
            ...
            try
            {
                ...
                //pictureBox.Image = new Bitmap(pictureBox.Image);
        ...
        } // End cropPictureButton_Click_1            
        private void rotatePictureButton_Click_1(object sender, EventArgs e)
        {
            SqlConnect();
            CreateDataAdapter2();
            FillTableAdapter2();
        ...
        } // End rotatePictureButton_Click_1
                        //
                        //
        ...
        private void batch1ToolStripButton_Click_2(object sender, EventArgs e)
        {
            try
            {
        ...
        } //end batch1ToolStripButton_Click_2
        private void batch2ToolStripButton_Click_2(object sender, EventArgs e)
        {
            try
            {
        ...
        } //end batch2ToolStripButton_Click_2
        ...
        private void fillByToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.view_HardCard_AllTableAdapter.FillBy(this.imsaAdminDevDataSet.view_HardCard_All);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        } // end fillByToolStripButton_Click
                          //
                          //
        ...
        private void sqlDataTableAdapterButton_Click_1(object sender, EventArgs e)
        {
            SqlConnect();
            CreateDataAdapter();
            FillTableAdapter();
        } // End sqlDataTableAdapterButton_Click_1
        ...
        {
            MyRefresh();
        } // End refreshButton_Click_1
        public void MyRefresh()
        {
            LoadData();    //SecForm_Load
            // Message to user
