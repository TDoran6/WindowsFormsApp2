...
{
    public partial class Next_Member_Form : Form
    {
        public Next_Member_Form()
        {
            InitializeComponent();
            Initialize_Next_Member_Form(); // Needs to be added to load settings that have been put in
        ...
        } //End Next_Member_Form()
          //Method to load settings
        private void Initialize_Next_Member_Form()
        {
            this.Height = Properties.Settings.Default.Next_Member_Form_Height;
            this.Width = Properties.Settings.Default.Next_Member_Form_Width;
            // register event handler (Next_Member_Form_ClosingEventHandler)
            this.FormClosing += Next_Member_Form_ClosingEventHandler;
            this.StartPosition = FormStartPosition.Manual;
        } // End Initialize_Next_Member_Form
          // method to handle the event (upon closing app)
        public void Next_Member_Form_ClosingEventHandler(object sender, FormClosingEventArgs e)
        {
            //set the settings that were made in the Settings.settings (in projects properties)
            Properties.Settings.Default.Next_Member_Form_Height = this.Height;
            Properties.Settings.Default.Next_Member_Form_Width = this.Width;
            Properties.Settings.Default.Save();
        } // End Next_Member_Form_ClosingEventHandler
                          //
                          //
        ...
        private void memberPrintPreviewButton_Click_1(object sender, EventArgs e)
        {
        ...
        } // End memberPrintPreviewButton_Click_1
        ...
        public void CreateDataAdapter()
        {
            ...
            try
            {
                String strSelect = "SELECT BatchPrint1 as 'Batch 1', BatchPrint2 as 'Batch 2', NameFull as Name, LicID as 'Membership #', Id, Season as 'Season' FROM Member Where  LicID = " + actionsTxtMembershipNumber.Text + " AND Season = 2020";
